...
local function initData()
    if globalStorage.init() then
        ...
        globalStorage.data.herbsData = require("morrowind_world_randomizer_openmw.scripts.morrowind_world_randomizer.generator.containers").generateHerbData()
        globalStorage.data.creaturesData = require("morrowind_world_randomizer_openmw.scripts.morrowind_world_randomizer.generator.creatures").generateCreatureData()
